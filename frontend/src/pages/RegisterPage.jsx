...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // pass API URL to register function
      const user = await register(formData, API);
      ...
      <div className="glass-panel p-10 sm:p-12 rounded-[2.5rem] w-full max-w-lg border border-white/10 shadow-2xl relative">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-text-muted font-light">
            Create your personal identity to start managing events
          </p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary sm:col-span-2 py-4 text-lg mt-2 disabled:opacity-50 flex items-center justify-center gap-2"
          >
